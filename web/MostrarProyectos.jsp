                    ...
                    <div class="container-fluid">
                        <div class="row">
                            <div class="m12 s12 s6 m6 l6 l12">
                                <br>
                                <h2 class="center black-text flow-text">Detalles de Proyectos</h2>
                                <br>
                                 <a class="btn btn-microsoft"  href="proyecto?action=insertal"><i class="fa fa-plus"></i>   Registrar Proyecto</a>
                                 <br>
                                 <br>
                                <table class="table table-responsive table-striped table-hover">
                                    ...
                                    <tbody>
                                        <c:forEach items="${lista}" var="mov" >
                                            <tr>
                                                <td>${mov.idproyecto}</td>
                                                <td>${mov.nombre}</td>
                                                <td>${mov.descripcion}</td>
                                                <td>${mov.idemp.idemp}</td>
                                                <td>${mov.fecha_inicia}</td>
                                                <td>${mov.fecha_estimada}</td>
                                                <td>${mov.fecha_finaliza}</td>
                                                <td >
                                                    <a class="btn btn-tumblr" href="proyecto?action=borrar&idproyecto=${mov.idproyecto}"><i class="fa fa-trash"></i></a>
                                                
                                                    <a class="btn btn-pinterest" href="proyecto?action=seleccionarByid&idproyecto=${mov.idproyecto}"><i class="fa fa-archive"></i></a>
                                                </td>
                                            </tr>
