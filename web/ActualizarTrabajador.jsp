                     ...
                     <div class="container-fluid">
                        <div class="row">
                            <div class="m12 s12 s6 m6 l6 l12">
                                <form action="trabajador?action=actualizar" method="POST">
                                    <c:forEach items="${lista}" var="t">
                                        <label>Id Trabajador</label>
                                        <input type="text" class="form-control" name="idetrabajador" value="${t.idtrabajador}">
                                        <label> Id profesion</label>
                                        <input type="text" class="form-control" name="nombrepro" value="${t.idprofesion.idprofesion}">
                                        <label>Nombre Empleado</label>
                                        <input type="text" class="form-control" name="nombre" value="${t.nombre}">
                                        <label>Apellido Empleado</label>
                                        <input type="text" class="form-control" name="apellidos" value="${t.apellidos}">
                                        <label>Dui</label>
                                        <input type="text" class="form-control" name="dui" value="${t.dui}">
                                        <label>Horas Trabajadas</label>
                                        <input type="text" class="form-control" name="horas" value="${t.horastrabaja}">
                                        <br>
                                        <button class="btn btn-microsoft" type="submit">Enviar</button>
                                        <a class="btn btn-danger" href="trabajador?action=mostrar">Cancelar</a>
                                    </c:forEach>
                                </form>
                                ${msg}
                            </div>
