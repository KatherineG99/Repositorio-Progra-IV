        ...
        <div class="wrapper">
            ...
            <div class="content-wrapper">
                ...
                <section class="content">
                    ...
                    <div class="container">
                        <div class="row">
                            <div class="m12 s12 s6 m6 l12">
                                <br>
                                <form action="proyecto?action=insertar" method="post">
                                    <label>Nombre de proyecto: </label>
                                    <input type="text" class="form-control" name="nombre" required="true">
                                    <br>    
                                    <label> Descripcion: </label>
                                    <br>
                                    <textarea name="descripcion" class="form-control" cols="5"></textarea>
                                    <br> 
                                    <label>Empresa: </label>
                                    <select type="idemp" class="form-control" name="nombre de la empresa">
                                        <c:forEach items="${listaemp}" var="emp">
                                            <option value="${emp.getIdemp()}">${emp.getNombre()}</option>
                                        </c:forEach>
                                    </select>
                                    ...
                                    <input type="date" class="form-control" min="2021-12-09" name="inicio" required="true">
                                    <br>  
                                    <label>Fecha estimada: </label>
                                    <input type="date" class="form-control" min="2021-12-09" name="estimada" required="true">
                                    <br>  
                                    <label>Fecha de finalizacion: </label>
                                    <input type="date" class="form-control" min="2021-12-09" name="finalizacion" required="true">
                                    <br> 
                                    <br>
