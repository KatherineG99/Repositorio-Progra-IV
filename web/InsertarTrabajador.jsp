                    ...
                    <div class="container">
                        <div class="row">
                            <div class="m12 s12 s6 m6 l6 l12 ">
                                <br>
                                <form action="trabajador?action=insertar" method="post">
                                    <label>Profesion: </label>
                                    <select type="id" class="form-control" name="idprofesion">
                                    ...
                                    <input type="text" class="form-control" name="horastrabaja" >
                                    <br>
