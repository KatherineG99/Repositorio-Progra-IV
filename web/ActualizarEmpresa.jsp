        ...
        <div class="wrapper">
            ...
            <div class="content-wrapper">
                ...
                <section class="content-header">
                    <h1>
                        Empresas asociadas
                        <small>Actualizacion de Empresa</small>
                    </h1>
                    <ol class="breadcrumb">
                        ...
                        <div class="row">
                            <div class="m12 s12 s6 m6 l6 l12">
                                <form action="empresa?action=actualizar" method="POST">
                                    <c:forEach items="${lista}" var="empr">
                                        <label>id</label>
                                        <input type="text" class="form-control" name="idemp" value="${empr.idemp}">
                                        <label>Nombre Empresa</label>
                                        <input type="text" class="form-control" name="nombre" value="${empr.nombre}">
                                        <label>Direccion</label>
                                        <input type="text" class="form-control" name="direccion" value="${empr.direccion}">
                                        <label>Telefono</label>
                                        <input type="text" class="form-control" name="telefono" value="${empr.telefono}">
                                        <label>Codigo Interno</label>
                                        <input type="text" class="form-control" name="codinter" value="${empr.codinter}">
                                        <br>
                                        <button class="btn btn-microsoft " type="submit">Enviar</button>
                                        <a class="btn btn-danger" href="empresa?action=mostrar">Cancelar</a>
                                    </c:forEach>
                                </form>
                                ${msg}
                            </div>
