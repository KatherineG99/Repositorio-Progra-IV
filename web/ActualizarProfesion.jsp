        ...
        <div class="wrapper">
            ...
            <div class="content-wrapper">
                ...
                <section class="content-header">
                    <h1>
                        Profesiones
                        <small>Actualizacion de Profesion</small>
                    </h1>
                    <ol class="breadcrumb">
                    ...
                    <div class="container-fluid">
                        <div class="row">
                            <div class="m12 s12 s6 m6 l6 l12">
                                <form action="profesion?action=actualizar" method="POST">
                                    <c:forEach items="${lista}" var="pro">
                                        <label>Id Profesion</label>
                                        <input type="text" class="form-control" name="idprofesion" value="${pro.idprofesion}">
                                        <label>Nombre Profesion</label>
                                        <input type="text" class="form-control" name="nombreprofesion" value="${pro.nombreprofesion}">
                                        <br>
                                        <button class="btn btn-microsoft" type="submit">Enviar</button>
                                        <a class="btn btn-danger" href="profesion?action=mostrar">Cancelar</a>
                                    </c:forEach>
                                </form>
                                ${msg}
                            </div>
