                    ...
                    <div class="container-fluid" >
                        <div class="row">
                            <div class="m12 s12 s6 m6 l6 l12">
                                ...
                                <h2 class="center black-text flow-text">Empresa Asociadas</h2>
                                <br>
                                <a class=" btn btn-microsoft" href="InsertarEmpresa.jsp"><i class="fa fa-plus"></i>  Registar Empresas</a>
                                <br>
                                <br>
                                    ...
                                    <tbody>
                                        <c:forEach items="${lista}" var="empr">
                                            <tr>
                                                ...
                                                <td>${empr.codinter}</td>
                                                <td >
                                                    <a class="btn btn-tumblr" href="empresa?action=borrar&idemp=${empr.idemp}"><i class="fa fa-trash"></i></a>

                                                    <a class="btn btn-pinterest" href="empresa?action=seleccionarByid&idemp=${empr.idemp}"><i class="fa fa-archive"></i></a>
                                                </td>
                                            </tr>
                                        </c:forEach>
                                    </tbody>
